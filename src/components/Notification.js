...
export function Notification({ open, close }) {
  ...
  return (
    <>
      <div className='fixed z-50 inset-0 flex px-4 mt-20 -mr-7 pointer-events-none sm:items-start hidden md:inline'>
        <div className='w-full flex flex-col space-y-4 sm:items-end'>
          <Transition
            ...
            leaveTo='opacity-0'
          >
            <div className='w-80 bg-white shadow-2xl rounded-l-xl ring-1 ring-black ring-opacity-5 p-2 flex items-center'>
              <div className='flex justify-center items-center bg-gray-50 rounded-lg w-7 h-7 mr-3'>
                <CheckedIcon />
              </div>

              <p className='text-primary font-medium'>E-mail copied successfully</p>
            </div>
          </Transition>
        </div>
      </div>

      <div className='fixed z-50 bottom-28 px-4 left-8 pointer-events-none inline md:hidden'>
        <div className='w-full flex flex-col items-center space-y-4'>
          ...
          >
            <div className='w-80 bg-white shadow-2xl rounded-xl ring-1 ring-black ring-opacity-5 p-2 flex items-center'>
              ...
              <p className='text-primary font-medium'>E-mail has sent successfully</p>
            </div>
          </Transition>
        </div>
      </div>
