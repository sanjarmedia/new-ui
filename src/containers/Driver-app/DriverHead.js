...
import WebApp from '../../../public/image/driverAppMobile.png';

export default function DriverHead(){
  return(
    <>
      <div className='md:w-full font-inter'>
        ...
        <div className='relative z-10 mt-32 text-center px-5 lg:px-72 xl:px-96'>
